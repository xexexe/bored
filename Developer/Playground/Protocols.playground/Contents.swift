...
class LinearCongruntialGenerator: RandomNumberGenerator {
    var lastRandom = 42.0
    let m = 139968.0
    let a = 3877.0
    let c = 29573.0
...
class SnakesAndLadders: DiceGame {
    let finalSquare = 25
    let dice = Dice(sides: 6, generator: LinearCongruntialGenerator())
    var square = 0
    var board: [Int]
    init() {
...
game.play()
// Strarted a new game of Snakes and Ladders
